...
- micro etapa 4.4 adiciona um prototipo experimental RGBA streaming atualizavel;
- micro etapa 4.5 troca o caminho experimental para tentar textura paletizada real do SDL3 com paleta separada;
- a flag muda apenas o caminho experimental de textura paletizada;
...
- rodar com `--debug-mode --debug-indexed-texture-path`: logs devem mostrar `debug_indexed_texture_path=1`;
- conferir `total_indexed_palette_updates`, `total_indexed_texture_update_pixels` e `total_indexed_texture_rgba_fallbacks`;
- `total_indexed_texture_rgba_fallbacks=0` indica que o caminho paletizado real foi aceito pelo renderer/driver.
